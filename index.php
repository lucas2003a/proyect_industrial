...
<head>
  ...
  <link rel="icon" type="image/x-icon" href="views/img/descarga-removebg-preview.png">
...
<body id="page-top">
  <!--Navitagion-->
    ...
    <!--conocenos-->
    <section class="conocenos-section text-center" id="conocenos">
      <div class="container px-4 px-lg-5">
    ...
    <!--trabajos-->
    <section class="trabajos-section bg-ligth" id="trabajos">
      <div class="container px-4 px-lg-5">
      <!--proyecto presentado-->
    ...
    <!--Contacto-->
    <section class="contacto-section bg-black">
      <div class="container px-4 px-lg-5">
        <div class="row gx-4 gx-lg-5">
