...
BEGIN
SELECT al.idalumno,usu.nomusuario,ma.idmatricula,secc.idseccion,ma.nombres,ma.apellidos,ma.documento_nro,ma.correo,ma.celular,al.profesion,gr.grado,secc.seccion,tur.turno,apo.nombres_apo,apo.celular_apo
FROM alumnos AS al
